...
class JFormFieldTwoJSimpleSlideshowDemo extends JFormFieldText{
	protected $type = 'TwoJSimpleSlideshowDemo';
	...
	protected function getLabel(){
		if( JComponentHelper::getParams('com_twojtoolbox')->get('twojpreview', 0)==0 ){
			...
			$twoj_add_js_field[] = $type_plugin.'*'.$plugin_info->v_active.'*js*2j.simpleslideshow';
			JRequest::setVar('twoj_add_js_field', $twoj_add_js_field );
			
			$twoj_add_css_field = JRequest::getVar('twoj_add_css_field', array(), '', 'array');
			$twoj_add_css_field[] = $type_plugin.'*'.$plugin_info->v_active.'*css*2j.simpleslideshow';
