...
?>
			<div class="fwgi-stats-views span3">
...
?>
			<div class="fwgi-stats-vote span3" id="rating<?php echo $this->row->id; ?>">
...
?>
	...
	<div class="fwgi-image">
		...
		<div class="fwgi-image-frame-left">
		<div class="fwgi-image-frame-right">
		<div class="fwgi-image-inner">
