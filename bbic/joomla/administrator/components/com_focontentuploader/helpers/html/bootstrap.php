...
abstract class JHtmlBootstrap
{
    ...
    public static function startTabSet($selector = 'myTab', $params = array())
    {
        ...
        $html = '<ul class="nav nav-tabs" id="' . $selector . 'Tabs"></ul><div class="tab-content" id="' . $selector . 'Content">';
    ...
    public static function addTab($selector, $id, $title)
    {
        ...
        $tabLayout = '<div id="' . $id . '" class="tab-pane' . $active . '">';

        // Inject tab into UL
        JFactory::getDocument()->addScriptDeclaration($tabScriptLayout);
