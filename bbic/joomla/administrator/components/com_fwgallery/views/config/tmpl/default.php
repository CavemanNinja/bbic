...
<div class="span4">
	...
	<fieldset class="adminform">
		...
		<legend><?php echo JText :: _('FWG_IMAGES_MANUAL_RESIZING'); ?></legend>
		<p><?php echo JText :: _('FWG_DESCR'); ?></p>
		<form action="index.php?option=com_fwgallery&amp;view=config" method="post" id="fw-manualresize-form" target="image_resize_target" enctype="multipart/form-data">
			<button type="button" class="btn btn-primary" name="resize_button"><?php echo JText :: _('FWG_RESIZE'); ?></button>
			<div class="clr"></div>
			<ul>
				<li><?php echo JText :: _('FWG_IMAGES_COUNTING'); ?><span id="fwgallery-manualresize-step-1"></span></li>
				<li><?php echo JText :: _('FWG_IMAGES_RESIZING'); ?><span id="fwgallery-manualresize-step-2"></span></li>
			</ul>
			<input type="hidden" name="layout" value="manualresize" />
			<input type="hidden" name="format" value="raw" />
			<input type="hidden" name="step" value="" />
			<input type="hidden" name="last_id" value="" />
		</form>
		<iframe name="image_resize_target" style="display:none;"></iframe>
	</fieldset>
	<fieldset class="adminform">
	...
	<fieldset class="adminform">
		...
		<table class="admintable">
			<tr>
				...
				<td>
					<?php echo JText :: _($this->obj->params->get('use_voting')?'FWG_Yes':'FWG_No'); ?>
				</td>
			</tr>
			<tr>
				<td class="key">
					<?php echo JText::_('FWG_VOTING_TYPE'); ?>:
				</td>
				<td>
					<?php echo JText :: _($this->obj->params->get('voting_type')?'FWG_THUMB_UP_DOWN':'FWG_STARS'); ?>
				</td>
			</tr>
			<tr>
				<td class="key">
				...
				<td>
					<?php echo JText :: _($this->obj->params->get('public_voting')?'FWG_Yes':'FWG_No'); ?>
				</td>
			</tr>
		</table>
	</fieldset>
...
<div class="span4">
	<fieldset class="adminform">
		...
		<table class="admintable">
			<tr>
				<td class="key">
					<?php echo JText :: _('FWG_USE_OWN_BOOTSTRAP'); ?>:
				</td>
				<td>
					<?php echo JText :: _($this->obj->params->get('use_own_bootstrap')?'FWG_YES':'FWG_NO'); ?>
				</td>
			</tr>
			<tr>
				<td class="key">
			...
			<tr>
				...
				<td>
					<?php echo JText :: _($this->obj->params->get('allow_image_download')?'FWG_Yes':'FWG_No'); ?>
				</td>
			</tr>
			<tr>
				<td class="key">
				...
				<td>
					<?php echo JText :: _($this->obj->params->get('display_image_tags')?'FWG_Yes':'FWG_No'); ?>
				</td>
			</tr>
			<tr>
				<td class="key">
				...
				<td>
					<?php echo JText :: _($this->obj->params->get('allow_print_button')?'FWG_Yes':'FWG_No'); ?>
				</td>
			</tr>
			<tr>
				<td class="key">
				...
				<td>
					<?php echo JText :: _($this->obj->params->get('hide_bottom_image')?'FWG_Yes':'FWG_No'); ?>
				</td>
			</tr>
			<tr>
				<td class="key">
			...
			<tr>
				...
				<td>
					<?php echo JText :: _($this->obj->params->get('display_galleries_lightbox')?'FWG_Yes':'FWG_No'); ?>
				</td>
			</tr>
			<tr>
				<td class="key">
				...
				<td>
					<?php echo JText :: _($this->obj->params->get('hide_mignifier')?'FWG_Yes':'FWG_No'); ?>
				</td>
			</tr>
			<tr>
				<td class="key">
					<?php echo JText::_('FWG_LIGHTBOX_SIZE'); ?>:
				</td>
				<td>
					<?php echo $this->obj->params->get('lightbox_size', 90); ?>%
				</td>
			</tr>
			<tr>
				<td class="key">
				...
				<td>
					<?php echo JText :: _($this->obj->params->get('hide_single_image_view')?'FWG_Yes':'FWG_No'); ?>
				</td>
			</tr>
			<tr>
				<td class="key">
				...
				<td>
					<?php echo JText :: _($this->obj->params->get('hide_iphone_app_promo')?'FWG_Yes':'FWG_No'); ?>
				</td>
			</tr>
			<tr>
				<td class="key">
			...
			<tr>
				...
				<td>
					<?php echo JText :: _($this->obj->params->get('hide_fw_copyright')?'FWG_Yes':'FWG_No'); ?>
				</td>
			</tr>
		</table>
	</fieldset>
	<fieldset class="adminform">
		<legend><?php echo JText::_('FWG_FRONTEND_MANAGEMENT'); ?></legend>
		<table class="admintable">
			<tr>
				<td class="key">
					<?php echo JText::_('FWG_ALLOW_FRONTEND_GALLERY_MANAGEMENT'); ?>:
				</td>
				<td>
					<?php echo JText :: _($this->obj->params->get('allow_frontend_galleries_management')?'FWG_YES':'FWG_NO'); ?>
				</td>
			</tr>
		</table>
	</fieldset>
	<fieldset class="adminform">
		<legend><?php echo JText::_('FWG_COMMENTING_SYSTEM'); ?></legend>
		<table class="admintable">
			<tr>
				<td class="key">
					<?php echo JText::_('FWG_SELECT_COMMENTING_SYSTEM'); ?>
				</td>
				<td>
					<?php $ct = $this->obj->params->get('comments_type'); echo JText :: _('FWG_'.($ct?$ct:'None')); ?>
				</td>
			</tr>
			<tr>
				<td class="key">
					<?php echo JText::_('FWG_Disqus_short_name'); ?>
				</td>
				<td>
					<?php echo $this->obj->params->get('disqus_domain'); ?>
				</td>
			</tr>
		</table>
	</fieldset>
	<fieldset class="adminform">
		<legend><?php echo JText::_('FWG_STOCK_SYSTEM'); ?></legend>
		<table class="admintable">
			<tr>
				<td class="key">
					<?php echo JText::_('FWG_Enable_STOCK_SYSTEM'); ?>
				</td>
				<td>
					<?php echo JText :: _('FWG_'.($this->obj->params->get('enable_stock')?'yes':'no')); ?>
				</td>
			</tr>
			<tr>
				<td class="key">
					<?php echo JText::_('FWG_PAYPAL_MODE'); ?>
				</td>
				<td>
					<?php echo JText :: _('FWG_'.($this->obj->params->get('paypal_mode')?'live':'sandbox')); ?>
				</td>
			</tr>
			<tr>
				<td class="key">
					<?php echo JText::_('FWG_PAYPAL_EMAIL'); ?>
				</td>
				<td>
					<?php echo $this->obj->params->get('paypal_email'); ?>
				</td>
			</tr>
			<tr>
				<td class="key">
					<?php echo JText::_('FWG_PAYPAL_CURRENCY'); ?>
				</td>
				<td>
					<?php echo $this->obj->params->get('paypal_currency'); ?>
				</td>
			</tr>
			<tr>
				<td class="key">
					<?php echo JText::_('FWG_CURRENCY_LABEL'); ?>
				</td>
				<td>
					<?php echo $this->obj->params->get('currency_label'); ?>
				</td>
			</tr>
			<tr>
				<td class="key">
					<?php echo JText::_('FWG_currency_position'); ?>
				</td>
				<td>
					<?php echo JText :: _('FWG_'.($this->obj->params->get('currency_position')?'Before':'After')); ?>
				</td>
			</tr>
		</table>
	</fieldset>
...
<div class="span4">
	<fieldset class="adminform">
		...
		<div><strong><?php echo JText::_('FWG_VERSION'); ?></strong>:<br/>3.2</div>
...
window.addEvent('domready', function() {
	...
	document.getElement(form.resize_button).addEvent('click', function() {
		if (confirm('<?php echo JText :: _('FWG_ARE_YOU_SURE_RESIZE_IMAGES', true); ?>')) {
			this.setProperty('disabled', true);
			document.getElement('#fwgallery-manualresize-step-1').innerHTML = ' - <img src="<?php echo JURI :: root(true); ?>/administrator/components/com_fwgallery/assets/images/pleasewait.gif" alt="<?php echo JText :: _('FWG_PLEASE_WAIT', true); ?>" />';
			form.step.value = 1;
			form.set('send', {
				evalScripts: true
			}).send();
