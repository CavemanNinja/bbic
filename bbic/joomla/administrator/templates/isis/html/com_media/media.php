...
if ($app->isAdmin()) {
   ...
   define('COM_MEDIA_BASE',    JPATH_ROOT . '/' . $params->get('user_content/'.$uid.'/images', 'user_content/'.$uid.'/images'));
   define('COM_MEDIA_BASEURL', JUri::root() . $params->get('user_content/'.$uid.'/images', 'user_content/'.$uid.'/images'));
}
