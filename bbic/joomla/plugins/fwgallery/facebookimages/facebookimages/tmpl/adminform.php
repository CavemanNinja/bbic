...
<form action="index.php?option=com_fwgallery&amp;view=plugins" method="post" name="logoutForm" id="fw-facebook-logout">
	<p>
...
<div class="tabbable">
	...
	<div class="tab-content">
		<div class="tab-pane active" id="fw-facebook-images-import-panel">
			<form action="index.php?option=com_fwgallery&amp;view=plugins" method="post" name="adminForm" id="fw-facebook-images-form-import">
		...
		<div class="tab-pane" id="fw-facebook-images-export-panel">
			<form action="index.php?option=com_fwgallery&amp;view=plugins" method="post" name="adminForm" id="fw-facebook-images-form-export">
				<table class="admintable">
					<tr>
						<td class="key"><?php echo JText :: _('FWGPF_SELECT_LOCAL_GALLERY'); ?></td>
...
window.addEvent('domready', function() {
	...
	document.getElement(form_import.stop_button).addEvent('click', function() {
        form_import.stop.value = 1;
    });
	document.getElement(form_import.import_button).addEvent('click', function() {
		...
		if (confirm(msg+' <?php echo JText :: _('FWGPF_GALLERY'); ?>?')) {
            ...
            document.getElement(form_import.stop_button).setStyle('display', '');
			document.getElement(form_import.import_button).setAttribute('disabled', true);
	...
	document.getElement(form_export.stop_button).addEvent('click', function() {
        form_export.stop.value = 1;
    });
	document.getElement(form_export.export_button).addEvent('click', function() {
		...
		if (confirm(msg+' <?php echo JText :: _('FWGPF_FACEBOOK_ALBUM'); ?>?')) {
            ...
            document.getElement(form_export.stop_button).setStyle('display', '');
			document.getElement(form_export.export_button).setAttribute('disabled', true);
