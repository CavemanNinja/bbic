...
?>
			<div class="fwg-vote-box">
				<a class="fwg-thumb-vote fwg-thumb-up" href="javascript:"><img src="<?php echo JURI :: root(true); ?>/components/com_fwgallery/assets/images/heart_vote.png" alt=""/></a>
				<!-- <a class="fwg-thumb-vote fwg-thumb-down" href="javascript:"><img src="<?php echo JURI :: root(true); ?>/components/com_fwgallery/assets/images/thumb_down.png" alt=""/></a> -->
			</div>
			<div class="fwg-vote-box">
				<?php echo round($this->row->_rating_sum, 2); ?><?php //echo (int)$this->row->_rating_count; ?> <?php //echo JText :: _($this->row->_rating_count!=1?'FWG_VOTES':'FWG_VOTE'); ?>
			</div>
<?php
} else {
?>
