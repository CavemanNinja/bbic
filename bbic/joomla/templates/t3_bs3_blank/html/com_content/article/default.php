		...
		<section class="article-content clearfix" itemprop="articleBody">
			...
			<div class="bbic-map">
				<div class="campus">
					...
					<i class="campus_building_w1"></i>
					<i class="campus_building_bdb"></i>
					<i class="campus_building_w3"></i>
					<i class="campus_building_w4"></i>
