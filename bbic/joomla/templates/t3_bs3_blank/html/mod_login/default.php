...
<?php else : ?>
	<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form">
		...
		<fieldset class="userdata">
			...
			<div class="login-controls inline-control-group">
				<div class="control-group inline-control-group">
					<input type="submit" name="Submit" class="btn btn-primary" value="<?php echo JText::_('JLOGIN') ?>"/>
				</div>
				<?php if (JPluginHelper::isEnabled('system', 'remember')) : ?>
				<div id="form-login-remember" class="control-group inline-control-group">
					<input id="modlgn-remember" type="checkbox"
						name="remember" class="input inline-control-group"
						value="yes"/> 
					<label id="mod-login-remember-label" for="modlgn-remember" class="checkbox inline-control-group">
						<?php 
							$remember_me = JText::_('MOD_LOGIN_REMEMBER_ME');
							echo trim($remember_me);
						?>
					</label>
				</div>
				<?php endif; ?>
